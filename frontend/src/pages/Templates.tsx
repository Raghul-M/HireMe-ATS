  ...
  const templates = [
    {
      ...
      description: "Software developer resume with cloud computing and scalable systems expertise",
    ...
    },
    {
      ...
      description: "Professional DevOps engineer resume with infrastructure and automation focus",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto">
          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            {templates.filter(template => template.isAvailable).map((template, index) => (
              <Card 
                key={template.id} 
          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {templates.filter(template => !template.isAvailable).map((template, index) => (
              <Card 
                ...
                style={{ animationDelay: `${(templates.filter(t => t.isAvailable).length + index) * 0.1}s` }}
              >
                <CardHeader className="pb-4">
                  <div className="aspect-[3/4] bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg mb-4 overflow-hidden border border-blue-100 relative">
